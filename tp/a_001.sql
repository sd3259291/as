...
INSERT INTO `s_access` VALUES (NULL,'adduser','hr',176,862),(NULL,'index','hr',176,861),(74,'edituser','hr',NULL,865),(74,'index','hr',NULL,861),(74,'dltuser','hr',NULL,866),(73,'newflow','fs',NULL,878),(72,'purchaseorder','purchase',NULL,890),(72,'vendorpricejust','purchase',NULL,892),(72,'vendorpricejustlist','purchase',NULL,893);
...
INSERT INTO `s_erp_config` VALUES (4,'vendor_price_just_flow','0','vendor_price_just'),(5,'vendor_price_just_only_dlt_myself','0','vendor_price_just');
...
CREATE TABLE `s_node` (
  ...
  KEY `pid` (`pid`),
  KEY `status` (`status`)
) ENGINE=MyISAM AUTO_INCREMENT=895 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
...
INSERT INTO `s_vendor_price` VALUES (13,'0101001','00002',1.000,13,1.130,'管理员','2020-05-21 09:46:36'),(14,'0101002','01000144',2.000,13,2.260,'管理员','2020-05-21 09:46:36'),(17,'0101002','00002',4.000,13,4.520,'管理员','2020-05-22 11:04:55'),(23,'0101001','00001',55.000,13,62.150,'管理员','2020-06-16 16:43:56');
